...
class Testpost(unittest.TestCase):
    ...
    def testDptPost01(self):
        # 定义消息体数据
        mydata1 = r'{"data":[{"dep_id":"T02","dep_name":"Test学院","master_name":"Test-Master","slogan":""}]}'
        # 发送请求，获取响应报文或者状态码
        res01 = requests.post(url=self.myurl, data=mydata1.encode("UTF-8"), headers=self.myheader)
        # 构建预期结果
        code_expect = "201"
        # 获取实际结果
