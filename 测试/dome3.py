...
class Testpost(unittest.TestCase):
    ...
    def testDptPost01(self):
        # 定义消息体数据
        mydata2 = r'{"data":[{"dep_id":"asdfghjklz","dep_name":"asdfghjklzasdfghjklz",' \
                 r'"master_name":"asdfghjklzasdfghjklz",' \
                 r'"slogan' \
                 r'":"asdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklzasdfghjklz"}]} '
        # 发送请求，获取响应报文或者状态码
        res01 = requests.post(url=self.myurl, data=mydata2.encode("UTF-8"), headers=self.myheader)
        # 构建预期结果
        code_expect = "201"
        # 获取实际结果
